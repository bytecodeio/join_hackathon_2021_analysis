# The name of this view in Looker is "Mbb Players Games Sr"
view: mbb_players_games_sr {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bytecodeio-datablocks.ncaa_basketball.mbb_players_games_sr`
    ;;
...
dimension: prim_key {
  ...
  measure: total_jersey_number {
    type: sum
    sql: ${jersey_number} ;;
  }

  measure: average_jersey_number {
    type: average
    sql: ${jersey_number} ;;
  }
