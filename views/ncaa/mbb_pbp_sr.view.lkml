# The name of this view in Looker is "Mbb Pbp Sr"
view: mbb_pbp_sr {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bytecodeio-datablocks.ncaa_basketball.mbb_pbp_sr`
    ;;
...
# }
  ...
  measure: total_timeout_duration {
    type: sum
    sql: ${timeout_duration} ;;
  }

  measure: average_timeout_duration {
    type: average
    sql: ${timeout_duration} ;;
  }
